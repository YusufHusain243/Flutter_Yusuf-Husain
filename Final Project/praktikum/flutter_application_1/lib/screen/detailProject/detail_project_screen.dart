...
import 'package:flutter_application_1/screen/detailProject/history_screen.dart';
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Consumer<DetailProjectViewModel>(builder: (build, value, child) {
              if (value.projectId.statusProject.toString() == "Finish") {
                return IconButton(
                  onPressed: () async {
                    showDialog<void>(
                      context: context,
                    ...
                    bool result = await value.updateStatus(
                      widget.idProject,
                      "On Progress",
                    );
                    if (result = true) {
                              ...
                              return Card(
                                child: Slidable(
                                  ...
                                  child: CheckboxListTile(
                                    title: Text(
                                      value.detailProjects[index].name
                                          .toString(),
                                    ),
